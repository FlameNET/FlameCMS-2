<?php
defined('installer') or die('No direct script access allowed');
if (isset($_POST["Submit"])) {
$enc_key=md5(uniqid("",true)).md5(uniqid("",true));
$base_url='https://';
...
$base_url.=$_SERVER['SERVER_NAME'].'/';
		$string = '<?php 
if ( defined(\'BASEPATH2\')) print_r(\'(this file was updated on install)\');		
...
/* Location: ./application/config/config.php */
';
		$fp = fopen("../application/config/config.php", "w");
		fwrite($fp, $string);
		fclose($fp);
